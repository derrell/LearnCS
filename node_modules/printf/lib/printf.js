require("../../../desktop/playground/source/class/playground/c/machine/Memory");
...
var Formatter = function(/*String*/ formatAddr){
  var tokens = [];
  var format = [];
  var i;
  ...
  this._tokens = tokenize(this._format, this._re, this._parseDelim, this);
};
